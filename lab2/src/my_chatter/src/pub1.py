...
def talker():
  ...
  #messages of type std_msgs/String to the topic /user_messages
  ...
  while not rospy.is_shutdown():
    ...
    input_string = "user input was: '%s' at time: %s" % (user_input, curr_time)
    msg = TimestampString(input_string, curr_time)
