...
def callback(message):
    ...
    print('Message: %s, Sent at: %s, Received at: %s' % (message.user_input, message.timestamp, rospy.get_time()))

#Define the method which contains the node's main functionality
def listener():

    #Create a new instance of the rospy.Subscriber object which we can 
    #use to receive messages of type std_msgs/String from the topic /user_messages.
